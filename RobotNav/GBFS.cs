...
namespace RobotNav
{
    public class GBFS
    {
        ...
        //constructors
        public GBFS(string fn, Agent a, Env e, List<Wall> w, Goals g)
        {
            fileName = fn;
        ...
        public string GetBestNode()
        {
            ...
            {
                int cost = GetHeuristic(node);                                                  //gives each node in frontier a cost using Heuristic
        ...
        public bool FinishSearch(string moves)                                  //checks if the path reaches goal
        {
            ...
            {
                goalFound = true;
                Console.WriteLine(fileName + " GBFS " + number_of_nodes);
