...
namespace RobotNav
{
    //CANT CHECK VISITED NODES WITH DLS, HOWEVER DLS TERMINATES AFTER ALL COMBINATIONS OF DEPTH SPECIFIED HAVE BEEN CHECKED
    public class DLS
    {
        ...
        //constructors
        public DLS(string fn, Agent a, Env e, List<Wall> w, Goals g, int dl)
        {
            fileName = fn;
        ...
        public bool FinishSearch(string moves)
        {
            ...
            {
                goalFound = true;
                Console.WriteLine(fileName + " DLS " + number_of_nodes);
